...
export function ProductosProvider({ children }) {
    ...
    function obtenerProductos() {
        return(
            new Promise((res, rej) => {
                fetch('https://682fbac4f504aa3c70f500b6.mockapi.io/tienda/2025/Productos')
                    .then((respuesta) =>
                        respuesta.json()
                    )
                    .then((datos) => {
    ...
    const agregarProducto = (producto) => {
        return(
            new Promise(async (res, rej) => {
                try {
                    const respuesta = await fetch('https://682fbac4f504aa3c70f500b6.mockapi.io/tienda/2025/Productos', {
                        method: 'POST',
                        headers: {
    ...
    function editarProducto(producto){
        return(
            new Promise(async(res, rej) => {
            try {
                const respuesta = await fetch(`https://682fbac4f504aa3c70f500b6.mockapi.io/tienda/2025/Productos/${producto.id}`, {
                    method: 'PUT',
                    headers: {
                    'Content-Type': 'application/json',
                    },
    ...
    const eliminarProducto = (id) => {
        ...
        if (confirmar) {
            return(
                new Promise(async (res, rej) => {
                    try {
                        const respuesta = await fetch(`https://682fbac4f504aa3c70f500b6.mockapi.io/tienda/2025/Productos/${id}`, {
                        method: 'DELETE',
                        });
